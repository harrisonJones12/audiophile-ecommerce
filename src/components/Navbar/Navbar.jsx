...
function Navbar({ hideMobileProductsMenu, hideMobileProducts, isDesktop }) {


  const desktopNavItems =
    <ul className="desktop-menu-items">
      <Link to="/"><li className="home">Home</li></Link>
      <li className="headphones">Heaphones</li>
      ...
      <header className="header-container">
        <nav className="navigation-main-container">
          <div className="icon-logo-group">
            <div className="inner-site-menu-wrapper">
              <div
              ...
              <svg width="143" height="25" xmlns="http://www.w3.org/2000/svg" className="audiophile-logo" data-testid="audiophile-logo" alt="audiophile-logo">
                <path
          ...
          {hideMobileProducts ? null : <Productslist />}
        </nav>
      </header>
    </>
  );
